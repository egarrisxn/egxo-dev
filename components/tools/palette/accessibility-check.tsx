...
import type { AccessibilityScore } from '@/lib/helpers/palette-helpers'

interface AccessibilityPassingProps {
  combinations: AccessibilityScore[]
}

export function AccessibilityPassing({
  combinations,
}: AccessibilityPassingProps) {
  return (
    <div>
...
export function AccessibilityFailing({
  combinations,
}: AccessibilityFailingProps) {
  return (
    <div>
